      ...
      <div id="layoutSidenav_nav">
        <nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
          <div class="sb-sidenav-menu">
            <div class="nav">
              <a class="nav-link active" href="http://localhost:8000/login/employee_dashboard">
              ...
              <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages" aria-expanded="false" aria-controls="collapsePages">
                <div class="sb-nav-link-icon">
                  <svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="book-open" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 576 512" data-fa-i2svg="">
              ...
              <a class="nav-link" href="charts.html">
                <div class="sb-nav-link-icon">
                  <svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="chart-area" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
              ...
              <a class="nav-link" href="tables.html">
                <div class="sb-nav-link-icon">
                  <svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="table" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" data-fa-i2svg="">
            ...
            <div class="card-body">
              <form>
                ...
                <div class="form-row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                        <label class="small mb-1" for="inputPassword">Categori</label>
                        <select id="register-candidate-category" class="register-category form-control" style="height:50px;" name="candidate_category">
                ...
                <div class="form-group mt-4 mb-0"><a class="btn btn-primary btn-block" href="login.html">Save Profile</a></div>
              </form>
            </div>
          </div>
        </main>
